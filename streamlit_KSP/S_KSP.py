...
GENERIC_KO = {
    ...
    "조직적", "SUPPORTERS", "지식관리", "MRC", "19", "세수입", "공무원연금", "코스타리카", "이력제", "전자폐기물", "문화산업", "상용화", "DNPI", "청정", "ALLBARO", "분류체계", "CCI", "축산업", "FDI", "INPI", "축산시설", "우루과", "수거", "대기업과"
}
GENERIC_EN = {
...
STOP_CUSTOM = {"높여", "기관별", "지속가능한", "공무원의", "있음", "사용자", "경제", "중소기업의", "조달", "공공", "개혁을", "기업들의", "라오스의", "분석",
               ...
               "산업", "혁신", "가나의", "전환", "집행", "파라과이의", "검색", "규제", "기술", "생태계를", "처리", "협력", "등록", "납세자", "폐기물", "정부", "민간", "투자", "예산"}
